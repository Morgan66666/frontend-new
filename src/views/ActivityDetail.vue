        ...
        <div class="detail-info">
          ...
          <div class="operation">
            <div class="book-button">
              <div class="book-button-content" @click="confirm">
                <div>立即预定</div>
              </div>
            </div>
            <div class="star-button">
              <div class="star" @click="star">
                <svg width="28" height="28" viewBox="0 0 28 28" xmlns="http://www.w3.org/2000/svg"
                     class="video-fav-icon video-toolbar-item-icon" data-v-b42ec39c="">
...
function confirm() {
  if (!activity.value) {
    console.error("活动信息未加载");
    return;
  }
  router.push({ path: '/confirm-order', query: { activityId: activity.value.activityId } });
}
